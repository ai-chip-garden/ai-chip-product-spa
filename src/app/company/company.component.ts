...
export class DestinationComponent implements OnInit{
    ...
    public backgroundName = '../../assets/company/background-company-desktop.jpg';
    ...
    public verifyMediaTablet(x) {
        ...
        if (x.matches) {
            ...
            style.backgroundImage = "url('../../assets/company/background-company-tablet.jpg')";
            document.getElementById('header').
    ...
    public verifyMediaMobile(x) {
        ...
        if (x.matches) {
            document.getElementById('header').
            style.backgroundImage = "url('../../assets/company/background-company-mobile.jpg')";
            document.getElementById('header').
            style.backgroundPosition = 'bottom';
        }
    }
    ...
    public verifyMediaDesktop(x){
        if (x.matches) {
            document.getElementById('header').
            style.backgroundImage = "url('../../assets/company/background-company-desktop.jpg')";
        }
    }
    changeImage(): void{
